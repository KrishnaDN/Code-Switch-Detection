...
from models.Multi_modal_No_Transformer import Multi_modal_No_Transformer
...
def main(config):
    ...
    model = Multi_modal_No_Transformer(config['input_dim'],config['vocab_len'],config['embedding_dim'],config['hidden_dim_AE'],config['hidden_dim_PE'])
...
if __name__ == "__main__":
    ...
    parser.add_argument('-save_modelpath',type=str, default='save_models_gujarati_no_transformer/')
