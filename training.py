...
from models.Multi_modal import Multi_modal
...
def train(model,dataloader_train,epoch,optimizer,device,criterion):
    ...
    for i_batch, sample_batched in enumerate(dataloader_train):
        ...
        optimizer.zero_grad()
        prediction = model(input_features,input_lengths,phonemes_ids,phonemes_lens)
...
def main(config):
    ...
    model = Multi_modal(config['input_dim'],config['vocab_len'],config['embedding_dim'],config['hidden_dim_AE'],config['hidden_dim_PE'])
...
if __name__ == "__main__":
    ...
    parser.add_argument('-training_filepath',type=str,default='meta/training_telugu.txt')
    parser.add_argument('-testing_filepath',type=str, default='meta/testing_telugu.txt')
    parser.add_argument('-config_file',type=str, default='config_telugu.yaml')
    parser.add_argument('-save_modelpath',type=str, default='save_models_telugu_no_transformer/')
