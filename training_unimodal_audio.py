...
from models.UniModal import AudioOnly
...
def train(model,dataloader_train,epoch,optimizer,device,criterion):
    ...
    for i_batch, sample_batched in enumerate(dataloader_train):
        ...
        optimizer.zero_grad()
        prediction = model(input_features,input_lengths)
...
def main(config):
    ...
    model = AudioOnly(config['input_dim'],config['hidden_dim_AE'],config['n_layers'])
...
if __name__ == "__main__":
    ...
    parser.add_argument('-save_modelpath',type=str, default='save_models_gujarati_audio_only/')
